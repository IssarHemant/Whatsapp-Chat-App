...
const MiddleContainer = () => {
  ...
  return (
    <>
    {/* Middle container */}
    <div className="h-screen overflow-y-scroll pb-[200px] w-screen xl:w-[430px] border border-l-0 border-r-gray-100 border-y-0">
    {/* Upper container */}
...
{/* Right assets */}
        <div className="flex gap-3">
          ...
          {/* Right second icon */}
          <div onClick={handleLogoutState} className="relative w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-100">
            <svg
              viewBox="0 0 24 24"
              height="24"
              width="24"
         ...
         <div className={`absolute right-0 top-10 z-10 bg-white border rounded-lg py-3 pl-4 w-[150px] trasition-all transform origin-top duration-300 cursor-pointer ${isLogout?"scale-y-100":"scale-y-0"}`}>
            <ul>
              <li className="mb-2" onClick={logout}>Logout</li>
...
{/* Search area */}
    ...
    <div className="xl:flex overflow-y-scroll hidden ml-2 mr-2">
      {/* <!-- cards area --> */}
     ...
     <div className="xl:hidden flex ml-2 mr-2">
      {/* Cards area */}
      <div className="flex-1">
        {/* Card 1 */}
        {filteredUsers.map((user) => (
